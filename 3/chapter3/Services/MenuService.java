...
public class MenuService {
	...
	private int menuItems [], menuItemSelected, parameter1, exitCode = 5,recursionCounter, triesLeftCounter = 5; // assignment operator
	...
	private void exitCodeChecker(){
		if (menuItemSelected == exitCode){  // relational operator
