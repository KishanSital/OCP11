...
import chapter21.utils.StringUtilsLoggedInMenuMessages;
...
public final class LoggedInMenuView implements MenuService, Cloneable {
    ...
    public LoggedInMenuView(FireArmsView fireArmsView,
        ...
        super();
        try {
            this.fireArmsView = (FireArmsView) fireArmsView.clone();
            this.expansionView = (ExpansionView) expansionView.clone();
    ...
    public void displayMenu() {
        ...
        do {
            ...
            switch (choiceEntry) {
                ...
                case 10:
                    resetAllValidationServices();
                    System.out.println(expansionView.deleteTables());
