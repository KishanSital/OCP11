package chapter21.models;

import chapter21.utils.StringUtilsExpansionModelMessages;

//generic class
public final class ExpansionModel <T extends Comparable<T>,U> implements Comparable<ExpansionModel<T,U>>{ // comparable interface for sorting
