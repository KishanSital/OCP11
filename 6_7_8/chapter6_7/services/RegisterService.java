...
import java.util.*;	
import static chapter6_7.services.TriesValidationService.*; // imports all static members which are public 
...
public class RegisterService{
	...
	public RegisterService (MailEntity mailEntity,
	...
	private void insertUser(){
		if (Constants.userRepository.addUserInterface.add(userEntity)){ // calling method of functional interface 
	...
	private void insertRegistrationMail(){
		...
		Constants.mailRepository.addMailInterface.add(mailEntity); // calling method of functional interface 
	}
}	