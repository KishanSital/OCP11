...
/*        for (int iteration = 0; iteration < args[IntUtilsMyPackage.PASSWORD_INDEX.getIntValue()].length(); iteration++) {
            chars[iteration] = args[IntUtilsMyPackage.PASSWORD_INDEX.getIntValue()].charAt(iteration);
        }*/
